...
```{r sample-obs, echo=FALSE, warning=FALSE, message=FALSE,cache=TRUE}
...
load("/Users/politicaltheory/Documents/github/pinochet/data/pinochet.RData")
...
pinochet %>% ungroup() %>% 
  ...
  geom_line(aes(x = Year, y = n)) +
  theme_minimal() +
  labs(x = NULL, y = NULL, title = "Number of Human Rights Abuses Against Students", 
       subtitle = "Pinochet Regime, 1973-1990") +
