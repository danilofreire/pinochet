...
On 11 September 1973, Army General Augusto Pinochet led a coup against Chile's socialist President Salvador Allende. The coup marked the beginning of a seventeen-year military dictatorship which combined large-scale political repression with rapid economic liberalisation [@meadowcroft2014hayek; @valdes1995pinochet]. In 1991, after the transition to democracy, then-President Patricio Aylwin created a commission to investigate human rights abuses in the Pinochet regime. The Report of the Chilean National Commission on Truth and Reconciliation [-@report1991], also known as the Rettig Report[^rettig], records over 2,000 cases of murders and disappearances from 1973 to 1990. In most cases, there are some details as to the personal characteristics of the victim, and where and when they died or disappeared. Despite its omissions[^omissions]. 
...
We can also explore how the government employed violence across space. We see that all types of violence were concentrated around Santiago and neighbouring cities. The results are in line with theoretical expectations. Santiago has been Chile's most densely populated city since the colonial times and in 1975 the city was home to about 30% of the country's population [@un1976yearbook].

[comment]: <> (Figure 03 - Spatial variation. Add a few more lines above)
