...
author: 
  ...
  - "Eugenia Guerrero[^eg]"
date: \today
thanks: "We thank Umberto Mignozzetti and Robert Myles McDonnell for their helpful comments. Replication materials and R source code are available at [`http://github.com/danilofreire/pinochet`](http://github.com/danilofreire/pinochet)."
...
| id                      | 276             |
| page                    | 265             |
| start date              | 18/01/1974      |
| end date                | 18/01/1974      |
| last name               | Marques Agusto  |
| first name              | Nelson José     |
| minor                   | 0               |
| age                     | 31              |
| male                    | 1               |
| occupation              | Office worker   |
| victim affiliation      | Communist party |
| violence                | 1 (killed)      |
| method                  | 1 (gun)         |
| interrogation           | NA (unknown)    |
| torture                 | NA (unknown)    |
| mistreatment            | 1 (yes)         |
| perpetrator             | Military        |
| place                   | 5 (in public)   |
| start location          | Iquique         |
| latitude 1              | -20.23070       |
| longitude 1             | -70.13567       |
| place 2                 | 4 (in custody)  |
| location 2              | Pisagua prison  |
| latitude 2              | -19.59667       |
| longitude 2             | -70.21222       |

Table: Sample event from the dataset (selected variables).
...
Table: Number of killings, disappearances, unresolved cases, and suicides 
...
[comment]: <> (Figure 01 - Time Trends Here)
\newpage 
...
[comment]: <> (Figure 02 - Spatial variation)
...
[comment]: <> (Figure 03 - Students and Communist Leaders)
