...
author: 
  ...
  - "Eugenia Guerrero[^eg]"
date: \today
thanks: "We thank Fábio Barros, Umberto Mignozzetti and Robert Myles McDonnell for their helpful comments. Replication materials and R source code are available at [`http://github.com/danilofreire/pinochet`](http://github.com/danilofreire/pinochet)."
abstract: "This article presents a georeferenced dataset on human rights violations in the Pinochet dictatorship in Chile. We coded the personal details of 2,398 victims named in the Chilean Truth Commission Report and added geographical coordinates for all identifiable atrocity locations. The dataset comprises 57 variables from 1973 to 1990 and is available as a stand-alone spreadsheet or as the `pinochet` package for `R`. As examples, we describe the major temporal and spatial patterns of the human rights abuses. We also discuss our coding procedures, show descriptive statistics, and conclude with suggestions for potential applications of the dataset."
...
On 11 September 1973, General Augusto Pinochet led a coup against Chile's socialist President Salvador Allende. The coup marked the beginning of a seventeen-year military dictatorship which combined rapid economic liberalisation with large-scale political repression [@meadowcroft2014hayek; @valdes1995pinochet]. In 1991, after Chile's transition to democracy, President Patricio Aylwin convened a commission to investigate human rights violations in the Pinochet regime. The Report of the National Commission on Truth and Reconciliation [-@report1991], also known as the Rettig Report[^rettig], recorded over 2,000 cases of murders and disappearances from 1973 to 1990. The Commission confronted the abuses of the past and portrayed a careful reconstruction of state violence during the military government. Most importantly, the Report contributed to the erosion of authoritarianism in Chile, as it fostered a series of criminal investigations that culminated with the indictment of General Pinochet in 2000 [@brahm2007uncovering 26]. 
...
Violence during transitions has characterised regime change in Latin America. Transitions to autocratic rule in Brazil (1964) and Argentina (1976) prompted frequent human rights violations that only recently have been fully documented [@agosin1987generals; @elpais2016argentina]. In some cases, autocrats declared unrestrained violence to be an explicit government policy. In 1992, Peru's former President Alberto Fujimori openly stated that his _autogolpe_ granted him the rights to "[apply] drastic punishments" towards any suspect of terrorism [@dabene1997narcodemocracias, 97; @samtleben2013constitucion, 56].
...
Example entry with the victim's characteristics\\ and information about their murder or disappearance.
\end{center}
\vspace{.5cm}
...
Number of killings, disappearances, unresolved cases, and suicides 
\end{center}
\vspace{.5cm}

[comment]: <> (Table 2 around here)
...
Two time trends: one with the whole period,\\ another discarding the first year to better visualise variation in later years
\end{center}
\vspace{.5cm}
...
Two maps: deaths and disappearances 
\end{center}
\vspace{.5cm}
...
Time trends: attacks against students and workers
\end{center}
\vspace{.5cm}
